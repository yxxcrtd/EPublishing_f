...
<div class="pagelink">
         ...
         <c:if test="${tPages>1 }">
         <!-- 上一页开始-->
         <c:if test="${form.curpage!=0 }"><a href="javascript:void(0)" onclick="changeNews('${form.curpage-1}')"><img
				src="${ctx }/images/prev.gif" class="vm" /> <ingenta-tag:LanguageTag sessionKey="lang" key="Global.Page.Prev"/></a></c:if>
         <!-- 上一页结束-->
         ...
         <a href="javascript:void(0)" onclick="changeNews('${form.curpage+1}')"><img
