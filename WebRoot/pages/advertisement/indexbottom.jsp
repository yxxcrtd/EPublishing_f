...
<%@ include file="/common/taglibs.jsp"%>
            <div class="banner">
	        <!-- 图片广告 -->
            <c:if test="${list[0].category==1 }"><a href="${list[0].url }" target="_blank"><img src="/upload/${list[0].file}" width="1024" height="78" onerror="this.src='${ctx}/images/nopic.jpg'"/></a></c:if>
            <!-- 代码广告 -->
