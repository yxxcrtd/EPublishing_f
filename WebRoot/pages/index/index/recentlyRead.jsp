		...
		<div class="block">
            ...
            <div class="fl w640">
				...
				<c:if test="${not empty p.publications.publisher.name}">
					<p><a href='${ctx }/index/search?type=2&isAccurate=1&searchValue2=${p.publications.publisher.name }'>${p.publications.publisher.name}</a><c:if test="${null != p.publications.pubDate && fn:substring(p.publications.pubDate,0,4)!=null}">(${fn:substring(p.publications.pubDate,0,4) })</c:if></p>
				</c:if>
