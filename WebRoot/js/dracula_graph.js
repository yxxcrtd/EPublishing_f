...
Graph.Renderer.Raphael.prototype = {
    ...
    draw: function() {
        ...
        for (i in this.graph.nodes) {
            this.drawNode(this.graph.nodes[i]);//���ƽڵ�
        }
    ...
    drawNode: function(node) {
        ...
        /* the default node drawing */
           ...
           // var color = Raphael.getColor();
            var color ="#C0C0C0";
            shape = this.r.set().
                push(this.r.rect(point[0], point[1], 60, 30).attr({fill: color, stroke: color, "stroke-width": 2})).
                push(this.r.text(point[0]+25, point[1] + 13, node.label || node.id));
        }
