...
<%@ page import="cn.digitalpublishing.util.web.IpUtil"%>
...
<ingenta-tag:LanguageTag key="Global.Page.Next" sessionKey="lang"/>
${sessionScope.lang}
<%
out.println("################  IP :  ###############:"+request.getRemoteAddr());
out.println("################  IP Convert:  ###############:"+IpUtil.getLongIp(request.getRemoteAddr()));
...
out.println(IpUtil.getIp(request));
%>
...
：</dt>
					...
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDexter_invoke_ip" />
