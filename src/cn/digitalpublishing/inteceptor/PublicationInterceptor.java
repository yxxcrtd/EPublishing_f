...
public class PublicationInterceptor extends ActionInterceptor {
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object o, Exception e) throws Exception {
		try {
			 ...
			 * condition.put("type", 1);//类型 condition.put("year",
			 ...
			 * condition.put("pubId", pubId);//产品Id List<LAccess> lalist =
			 ...
			 * getId()); Integer yue = Integer.valueOf(StringUtil.formatDate(new
			 * Date(),"MM")); switch (yue) { case 1:{
			 ...
			 * laccess.setMonth1(laccess.getMonth1()==null?1:(laccess.getMonth1(
			 * )+1)); break; } } laccess.setCreateOn(new Date());
